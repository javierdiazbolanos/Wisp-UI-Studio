      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 dark:text-neutral-400">
                Unsaved changes detected in your editor
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-4 rounded-2xl bg-neutral-50 dark:bg-neutral-900/90 border border-neutral-200 dark:border-neutral-800 space-y-2.5">
          <p className="text-xs leading-relaxed text-neutral-700 dark:text-neutral-300">
            You are about to load the template{" "}
            <span className="font-bold text-purple-600 dark:text-purple-400">
              "{targetTemplate.title}"
            </span>
            . Loading this will replace the current code in your editor.
          </p>
          <div className="flex items-center gap-2 text-[11px] text-amber-700 dark:text-amber-300 font-medium">
            <ShieldAlert className="w-4 h-4 shrink-0" />
            <span>
              We recommend downloading a backup copy of your{" "}
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2.5 pt-2">
          ...
          >
            ...
            <span>Download .wdsl & Switch</span>
          </button>
        </div>
      </div>
    </div>
